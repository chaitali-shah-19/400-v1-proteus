...
thermal= make_fn_thermal('2017-07-13_18.56.56_carbon_ext_trig_shuttle',path); %THIS IS MAIN THERMAL
...
% wihout mirror
%thermal= make_fn_thermal('2017-07-29_20.57.39_carbon_ext_trig_shuttle',path);
...
for j=1:size(files_return,1)
    ...
    [enhancementFactor(j),fwhm3,spec20{j},spec30{j}]=process_enhancement(spec2,spec3,num_avg);
