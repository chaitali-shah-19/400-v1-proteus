function vnr_output = vnread2(filename,filter_linewidth,temperature,pressure,options)
...
baseline = mean(fid(round(7/8*s(1)):end,:));  % baseline correction
fid = fid - repmat(baseline,[s(1) 1]);
