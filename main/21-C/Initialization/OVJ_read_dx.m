function files_return = OVJ_read_dx(explimits)

% Collect the date limits and convert to numerical values
...
% Set directory name
dirName='C:\Users\Anika\Documents\MATLAB\Data\';
fn=dirName;

% list all files regardless of extension
files2 = dir( fullfile(dirName,'*fidecay*') ) ;
files = [{files2.name}'];

% grab all files in between explimits
...
% Order files into function output?
