...
function [par, img, k, kraw] = fidread_muller(fpath,nodc)
...
fpath_par='2017-08-20_18.34.43_carbon_ext_trig_shuttle\complete.fid';


par = getparam(fpath_par);
par.path=fpath;
[kraw, hdr] = readfid_muller(fpath,par,~nodc);
