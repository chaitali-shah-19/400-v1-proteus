function result_seq = rabi_pulse_mod_plus_CST_gaussian_static_noise(seq,sample_rate,length_rabi_pulse,mod_depth,noise,ch_on)

seq = ttl_pulse(seq, 2, length_rabi_pulse);

vector_mod_plus_noise =  (mod_depth+noise)*ones(1,int64(sample_rate*(length_rabi_pulse)));
