function result_seq = rabi_pulse_mod(seq,sample_rate,length_rabi_pulse,mod_depth,ch_on)

seq = ttl_pulse(seq, 2, length_rabi_pulse);

seq.Channels(2).Ampmod = [seq.Channels(2).Ampmod mod_depth*ones(1,int64(sample_rate*(length_rabi_pulse)))];
