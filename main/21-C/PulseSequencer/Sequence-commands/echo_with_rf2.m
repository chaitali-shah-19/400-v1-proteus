function result_seq = echo_with_rf2(seq,sample_rate,tau,length_pi_over_2,rf_freq,mod_rf,mod_mw,ch_on)
...
seq.Channels(5).FreqmodI = [seq.Channels(5).FreqmodI zeros(1,int64(sample_rate*(switch_wait+length_pi_over_2/2))) mod_rf*sin(2*pi*t*rf_freq) zeros(1,int64(sample_rate*(length_pi_over_2/2+Aux)))]; 
