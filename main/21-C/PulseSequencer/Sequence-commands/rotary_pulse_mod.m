function result_seq = rotary_pulse_mod(seq,sample_rate,mod,length_rotary_pulse,flip_angle_rad,ch_on)

seq = ttl_pulse(seq, 2, length_rotary_pulse);

seq.Channels(2).Ampmod = [seq.Channels(2).Ampmod mod*ones(1,int64(sample_rate*length_rotary_pulse))];
