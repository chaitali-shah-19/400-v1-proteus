...
inst.SendScpi(':TASK:COMP:LOOP 10');
inst.SendScpi(':TASK:COMP:SEQ 1');
inst.SendScpi(':TASK:COMP:SEGM 1'); 
inst.SendScpi(':TASK:COMP:IDLE DC');
inst.SendScpi(':TASK:COMP:DEF:IDLE:LEV 0');
...
inst.SendScpi(':TASK:COMP:NEXT1 2');
inst.SendScpi(':TASK:COMP:NEXT2 0');
inst.SendScpi(':TASK:COMP:DEL 0');
...
res1 = inst.SendScpi(':TASK:CURR?')
        assert(res1.ErrCode == 0);
