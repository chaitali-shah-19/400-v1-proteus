...
%                                 end
                        ...
                        if ~err && ~handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted
                            disp('Load sequence to pulse blaster');
                        ...
                        if handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted==1
                           ...
                           %handles.Imaginghandles.ImagingFunctions.interfacePulseGen.PBReset();
                            ...
                            if handles.Array_PSeq{1}.Channels(12).Enable % For motion
                                ...
                                if ~handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted
                                    pause(1.03*sum(durPB)); %3 sec between reps
                                end
...
%                                 disp('Wrote Sage write 4: Move down and read the data in');
                                ...
                                t = timer;
                                t.StartFcn = @(~,~) disp('Wrote Sage write 4: Move down and read the data in');
                ...
                pause(0.5);
%                 disp('Wait for the shuttler to move back up');
                
                disp('Closing PulseBlaser Board');
                handles.Imaginghandles.ImagingFunctions.interfacePulseGen.PBClose();
                disp('Unloading PulseBlaster library');
                handles.Imaginghandles.ImagingFunctions.interfacePulseGen.UnloadLib();
...
%                 pause(30);
                ...
                disp('Reloading PulseBlaster library');
                handles.Imaginghandles.ImagingFunctions.interfacePulseGen.Initialize();
                disp('Reloading PulseBlaster Board');
                handles.Imaginghandles.ImagingFunctions.interfacePulseGen.PBInit();
