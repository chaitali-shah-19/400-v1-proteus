...
%                                        Tmax=Tmax*12*1e-3;
%                                        nc=nc*12;
                                       Tmax=Tmax*14*1e-3; %Tmax times number of pulses in sequence pulsed_spinlock
                                       nc=nc*14; %nc times number of aquire windows in pulsed_spinlock? 
...
%                                                  end
                                        ...
                                        time_cycle = ((18e-6)+delay2+(tacq+2+4+10)*1e-6)*1 %this may be set differently as we plan to trigger on falling edge, time to do a pulse-acquire
