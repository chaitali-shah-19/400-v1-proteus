...
%                                               obj.tabor.awg_start();
                                       ...
                                       %% TURN ON RIGOL/TABOR AWG FOR MAG
                                       if length(handles.Array_PSeq{1}.Channels)>=42
                                           if handles.Array_PSeq{1}.Channels(42).Enable && ~handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted
                                               ...
                                               rigol_DC_offset=handles.Array_PSeq{helper_scan,aux}.Channels(42).Phase;
                                               mod_state=handles.Array_PSeq{helper_scan,aux}.Channels(42).Frequency;
                                               if length(handles.Array_PSeq{1}.Channels)>=43 %sweep mode
                                                   if handles.Array_PSeq{1}.Channels(43).Enable && ~handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted
                                                       rigol_swp_sta=handles.Array_PSeq{helper_scan,aux}.Channels(43).FreqmodI;
                                                       rigol_swp_stop=handles.Array_PSeq{helper_scan,aux}.Channels(43).FreqmodQ;
                                                       chirpT=handles.Array_PSeq{helper_scan,aux}.Channels(43).Amplitude;
                                                       obj.arb_mag.set_sweep(rigol_swp_sta,rigol_swp_stop,chirpT,rigol_Vpp)
                                                       %obj.arb_mag_tabor(rigol_swp_sta,rigol_swp_stop,rigol_Vpp,chirpT,1);
                                                       pause(1);
                                                   end
                                               end
                                               rigol2_Vpp=handles.Array_PSeq{helper_scan,aux}.Channels(42).AmpIQ;
                                               rigol2_freq=handles.Array_PSeq{helper_scan,aux}.Channels(42).FreqIQ;
                                               %obj.arb_mag2.set_sine_wave(rigol2_freq,rigol2_Vpp,0);

                                                rigol_freq=handles.Array_PSeq{helper_scan,aux}.Channels(42).FreqmodQ;
                                               rigol_freq=1/4/(32+11+pw_current)*1e6;
                                               fprintf('The AC field frequency is %0.4f Hz.\n',(rigol_freq));
                                               obj.arb_mag.set_sine_wave(rigol_freq,rigol_Vpp,rigol_DC_offset);
                                               pause(1);
                                               if mod_state==1
                                                   mod_freq=handles.Array_PSeq{helper_scan,aux}.Channels(42).Amplitude;
                                                   obj.arb_mag.set_mod(mod_freq);
                                                   pause(0.1);
                                               end
                                               obj.arb_mag.MW_RFOn();
                                               pause(0.1);
...
%                                                end
                                               ...
                                               if length(handles.Array_PSeq{1}.Channels)>=45
                                                   if handles.Array_PSeq{1}.Channels(45).Enable && ~handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted
                                                       if mod_state==1
                                                           obj.arb_mag_tabor.set_AMmod(rigol_freq,mod_freq,rigol_Vpp)
                                                           pause(0.1);
                                                       elseif mod_state==0
                                                           obj.arb_mag_tabor.set_sine_wave(rigol_freq,rigol_Vpp,rigol_DC_offset,0,1);
                                                           pause(0.1);
%                                                            obj.arb_mag_tabor.set_sine_wave(rigol_freq,rigol2_Vpp,0,45,2);
%                                                            pause(0.1);
                                                           obj.arb_mag_tabor.set_gate();
                                                           pause(0.1);
                                                       elseif mod_state==2
                                                           obj.arb_mag_tabor.set_arb(rigol_Vpp,4,rigol2_Vpp);
                                                           pause(0.1);
                                                       end

                                                       if length(handles.Array_PSeq{1}.Channels)>=43 %sweep mode
                                                           if handles.Array_PSeq{1}.Channels(43).Enable && ~handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted
                                                               fstart=handles.Array_PSeq{helper_scan,aux}.Channels(43).FreqmodI;
                                                               fstop=handles.Array_PSeq{helper_scan,aux}.Channels(43).FreqmodQ;
                                                               chirpT=handles.Array_PSeq{helper_scan,aux}.Channels(43).Amplitude;
                                                               obj.arb_mag_tabor.set_sweep(fstart,fstop,rigol_Vpp,chirpT,1);
                                                               pause(0.1);
                                                               obj.arb_mag_tabor.set_sweep(fstart,fstop,rigol_Vpp,chirpT,1);
                                                               pause(0.1);
                                                               obj.arb_mag_tabor.set_sweep(fstart,fstop,rigol_Vpp,chirpT,1);
...
%                                                                obj.arb_mag_tabor.set_gate();
                                                       ...
                                                       obj.arb_mag_tabor.MW_RFOn(1);
                                                       pause(0.1);
                                                       %                                                        obj.arb_mag_tabor.MW_RFOn(2);
                                                       %                                                        pause(0.1);
                                                   end
                                               end
...
%                                                         pause(0.1);
                                        ...
                                        if length(handles.Array_PSeq{1}.Channels)>=45 %sweep mode
                                            if handles.Array_PSeq{1}.Channels(45).Enable && ~handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted
                                           
                                                obj.arb_mag_tabor.MW_RFOff(1);
                                                pause(0.1);
                                                obj.arb_mag_tabor.MW_RFOff(2);
                                                pause(0.1);
                                            end
                                        end
