...
%                             end
                        ...
                        endpulse
                            ...
                            if sequence_type == 2  %spin lock sequence type, can uncomment others later
                                ...
                                [nc,Tmax]= make_pw_nmr_8(pw_current,tacq_current,gain_current,PW2_current,tof_current);
                                pause(0.1);
                                %for next cycle
                                make_pw_nmr_8(pw,tacq,gain,PW2,tof);
                                ...
                                %Instead of sage_write_2, we do following
                                pw = pw_current*1e-6;
                    ...
                    if handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted==1
                        ...
                        if handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted==1
                            ...
                            if handles.Array_PSeq{1}.Channels(12).Enable % For motion
                                if ~handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted
                                    pause(Wait_time+3); %WAIT TIME + 3 SECONDS DELAY TO ENSURE WE DONT CUT MW OFF EARLY
                                    Sage_write(['4']);
...
%                                 py.Clicker.LPWAD(6.11);
                ...
                %handles.ExperimentFunctions.swabian.r0.15
