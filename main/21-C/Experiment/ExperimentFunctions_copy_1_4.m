...
%                               
                            ...
                            if handles.Array_PSeq{1}.Channels(19).Enable && ~handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted
                                ...
                                [vco1_range,vco1_volt]=spike_matching_func(obj.pw1,obj.arb1,4.606,10.81,bw_center-bw_range/2,bw_center+bw_range/2,A1,B1);
                                dc_level=vco1_volt;
                                Vpp=vco1_range;
                                end
                                end
                            ...
                            if handles.Array_PSeq{1}.Channels(21).Enable && ~handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted
                               ...
                               A2=1.824469; B2=0.136353;
                                ...
                                [vco2_range,vco2_volt]=spike_matching_func(obj.pw2,obj.arb2,4.606,10.81,bw_center-bw_range/2,bw_center+bw_range/2,A2,B2);
                                dc_level2=vco2_volt;
                                Vpp2=vco2_range;
                                end
                                end
...
%                             
                            if handles.Array_PSeq{1}.Channels(22).Enable && ~handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted
                                ...
                                [vco3_range,vco3_volt]=spike_matching_func(obj.pw3,obj.arb3,4.606,10.81,bw_center-bw_range/2,bw_center+bw_range/2,A3,B3);
                                dc_level3=vco3_volt;
                                Vpp3=vco3_range;
                                end
                                end
...
%                             
                            ...
                            if handles.Array_PSeq{1}.Channels(23).Enable && ~handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted
                                ...
                                [vco4_range,vco4_volt]=spike_matching_func(obj.pw4,obj.arb4,4.606,10.81,bw_center-bw_range/2,bw_center+bw_range/2,A4,B4);
                                dc_level4=vco4_volt;
                                Vpp4=vco4_range;
                                end
                                end
