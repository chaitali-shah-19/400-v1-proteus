...
% Last Modified by GUIDE v2.5 28-Jun-2022 14:12:21
...
% tc=gpib('ni',0,24); %sets (instrument #, primary address)
% fopen(tc);
% tc.EOSMode = 'read&write';
% tc.EOSCharCode = 'CR'; 
% fprintf(tc,'C3'); %sets the controls panel to remote & unlocked
% fprintf(tc,'M20.0'); %set the max voltage to +20.0V every time
% handles.tc=tc;
