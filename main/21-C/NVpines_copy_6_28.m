...
% Last Modified by GUIDE v2.5 28-Jun-2022 10:37:09
...
function temp_box_Callback(hObject, eventdata, handles)
% hObject    handle to temp_box (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of temp_box as text
%        str2double(get(hObject,'String')) returns contents of temp_box as a double
