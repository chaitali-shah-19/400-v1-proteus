...
%            
        ...
        function handles = StartScan1D(obj,handles)
            ...
            points=length(obj.CurrentScanMat{logical(obj.bEnable)});
            %prelocate memory for image
            handles.ConfocalScan.ImageData = zeros(1,length(obj.CurrentScanMat{logical(obj.bEnable)}));
            
             %stablize_time=50e-3; %time for piezo to reach const velocity
...
%             
           ...
           % set(handles.NSQDnumber, 'String', 'NSQD line = ');
            ...
            if obj.bEnable(1) % X scan
                ...
                [n_points,piezo_sampletime]=obj.interfaceScanning.Scan(NewScan,handles.Yinit,handles.Zinit,handles.ConfocalScan.DwellTime,1);
                ...
                pause(piezo_sampletime*n_points*1.2);
...
%             handles.ImagingFunctions.interfaceDataAcq.WriteAnalogOutLine(1);
        ...
        function handles = StartScan2D(obj,handles)
            ...
            zaber_obj = handles.zaber_obj; %this is the actuator object
           ...
           %stablize_time=50e-3; %time for piezo to reach const velocity
           stablize_time=0e-3; %time for piezo to reach const velocity
           points_extra= ceil(stablize_time/handles.ConfocalScan.DwellTime); %these are the extra points we add on the left side of the waveform
           points=points+points_extra;
               ...
               clear tStart tElapsed;
                if ind == 1
                   ...
                   elseif strcmp(scan_code,'xY')
                        slope=obj.CurrentScanMat{2}(2)-obj.CurrentScanMat{2}(1);
                        extra_array=linspace(obj.CurrentScanMat{2}(1)-slope*points_extra,obj.CurrentScanMat{2}(1)-slope,points_extra);
                        NewScan=[extra_array obj.CurrentScanMat{2}]; %shift scan region left by extra points
                        [n_points,piezo_sampletime]=obj.interfaceScanning.Scan(obj.CurrentScanMat{1}(ind),NewScan,obj.interfaceScanning.Pos(3),handles.ConfocalScan.DwellTime,2);
           ...
           %[n_points,piezo_sampletime]=obj.interfaceScanning.Scan(obj.CurrentScanMat{1}(ind),obj.CurrentScanMat{2},obj.interfaceScanning.Pos(3),handles.ConfocalScan.DwellTime,2);
                        ...
                        pause(piezo_sampletime*n_points*1.2);
                        obj.interfaceScanning.WAVETABLE_ENABLE(0,ramp_axis);
                    elseif strcmp(scan_code,'Xz') && Piezotoggle==0
                        slope=obj.CurrentScanMat{1}(2)-obj.CurrentScanMat{1}(1);
                        extra_array=linspace(obj.CurrentScanMat{1}(1)-slope*points_extra,obj.CurrentScanMat{1}(1)-slope,points_extra);
                        NewScan=[extra_array obj.CurrentScanMat{1}]; %shift scan region left by extra points
                        [n_points,piezo_sampletime]=obj.interfaceScanning.Scan(NewScan,obj.interfaceScanning.Pos(2),obj.CurrentScanMat{3}(ind),handles.ConfocalScan.DwellTime,1);
                     ...
                     elseif strcmp(scan_code,'Xz') && Piezotoggle==1 %This is for xz scan with the actuator
                         
                         handles.zscan_start=str2num(get(handles.Pos_obj,'String')); 
                         absolutePosition = (handles.Zactinit + obj.CurrentScanMat{3}(ind)*1e-3)*1e-3; %thats because we enter the numbers in microns
                        ...
                        extra_array=linspace(obj.CurrentScanMat{1}(1)-slope*points_extra,obj.CurrentScanMat{1}(1)-slope,points_extra);
                        NewScan=[extra_array obj.CurrentScanMat{1}]; %shift scan region left by extra points
                        [n_points,piezo_sampletime]=obj.interfaceScanning.Scan_act(NewScan,obj.interfaceScanning.Pos(2),obj.interfaceScanning.Pos(3),handles.ConfocalScan.DwellTime,1);
                     ...
                     elseif strcmp(scan_code,'xZ') && Piezotoggle==0
                        slope=obj.CurrentScanMat{3}(2)-obj.CurrentScanMat{3}(1);
                        extra_array=linspace(obj.CurrentScanMat{3}(1)-slope*points_extra,obj.CurrentScanMat{3}(1)-slope,points_extra);
                        NewScan=[extra_array obj.CurrentScanMat{3}]; %shift scan region left by extra points
                        [n_points,piezo_sampletime]=obj.interfaceScanning.Scan(obj.CurrentScanMat{1}(ind),obj.interfaceScanning.Pos(2),NewScan,handles.ConfocalScan.DwellTime,3);
                    ...
                    elseif strcmp(scan_code,'Yz') && Piezotoggle==0
                        slope=obj.CurrentScanMat{2}(2)-obj.CurrentScanMat{2}(1);
                        extra_array=linspace(obj.CurrentScanMat{2}(1)-slope*points_extra,obj.CurrentScanMat{2}(1)-slope,points_extra);
                        NewScan=[extra_array obj.CurrentScanMat{2}]; %shift scan region left by extra points
                        [n_points,piezo_sampletime]=obj.interfaceScanning.Scan(obj.interfaceScanning.Pos(1),NewScan,obj.CurrentScanMat{3}(ind),handles.ConfocalScan.DwellTime,2);
                     ...
                     elseif strcmp(scan_code,'Yz') && Piezotoggle==1 %This is for YZ scan with the actuator
                        ...
                        extra_array=linspace(obj.CurrentScanMat{2}(1)-slope*points_extra,obj.CurrentScanMat{2}(1)-slope,points_extra);
                        NewScan=[extra_array obj.CurrentScanMat{2}]; %shift scan region left by extra points
                        [n_points,piezo_sampletime]=obj.interfaceScanning.Scan_act(obj.interfaceScanning.Pos(1),NewScan,obj.interfaceScanning.Pos(3),handles.ConfocalScan.DwellTime,2);
                    ...
                    elseif strcmp(scan_code,'yZ') && Piezotoggle==0
                        ...
                        extra_array=linspace(obj.CurrentScanMat{3}(1)-slope*points_extra,obj.CurrentScanMat{3}(1)-slope,points_extra);
                        NewScan=[extra_array obj.CurrentScanMat{3}]; %shift scan region left by extra points
                        [n_points,piezo_sampletime]=obj.interfaceScanning.Scan(obj.interfaceScanning.Pos(1),obj.CurrentScanMat{2}(ind),NewScan,handles.ConfocalScan.DwellTime,3);
                    ...
                    if  strcmp(scan_code,'Xy') %Scan(obj, X,Y,Z, TPixel, ramp_axis)    
                        ...
                        NewScan=[extra_array obj.CurrentScanMat{1}]; %shift scan region left by extra points
                        [n_points,piezo_sampletime]=obj.interfaceScanning.Trigg(NewScan,obj.CurrentScanMat{2}(ind),obj.interfaceScanning.Pos(3),handles.ConfocalScan.DwellTime,1,n_points);
                    ...
                    elseif strcmp(scan_code,'xY')
                        ...
                        extra_array=linspace(obj.CurrentScanMat{2}(1)-slope*points_extra,obj.CurrentScanMat{2}(1)-slope,points_extra);
                        NewScan=[extra_array obj.CurrentScanMat{2}]; %shift scan region left by extra points
                        [n_points,piezo_sampletime]=obj.interfaceScanning.Trigg(obj.CurrentScanMat{1}(ind),NewScan,obj.interfaceScanning.Pos(3),handles.ConfocalScan.DwellTime,2,n_points);
                     
                        %[n_points,piezo_sampletime]=obj.interfaceScanning.Trigg(obj.CurrentScanMat{1}(ind),obj.CurrentScanMat{2},obj.interfaceScanning.Pos(3),handles.ConfocalScan.DwellTime,2,n_points);
                        ramp_axis=2;
                        obj.interfaceScanning.WAVETABLE_ENABLE(1,ramp_axis);
                        obj.interfaceDataAcq.StartTask('Counter');
                        obj.interfaceScanning.WAVETABLE_ACTIVE(1,ramp_axis);
                    ...
                    elseif strcmp(scan_code,'Xz')&& Piezotoggle==0
                        ...
                        extra_array=linspace(obj.CurrentScanMat{1}(1)-slope*points_extra,obj.CurrentScanMat{1}(1)-slope,points_extra);
                        NewScan=[extra_array obj.CurrentScanMat{1}]; %shift scan region left by extra points
                        [n_points,piezo_sampletime]=obj.interfaceScanning.Trigg(NewScan,obj.interfaceScanning.Pos(2),obj.CurrentScanMat{3}(ind),handles.ConfocalScan.DwellTime,1,n_points);
                       
                        %[n_points,piezo_sampletime]=obj.interfaceScanning.Trigg(obj.CurrentScanMat{1},obj.interfaceScanning.Pos(2),obj.CurrentScanMat{3}(ind),handles.ConfocalScan.DwellTime,1,n_points);
                        ramp_axis=1;
                        obj.interfaceScanning.WAVETABLE_ENABLE(1,ramp_axis);
                        obj.interfaceDataAcq.StartTask('Counter');
                        obj.interfaceScanning.WAVETABLE_ACTIVE(1,ramp_axis);
                   ...
                   elseif strcmp(scan_code,'Xz')&& Piezotoggle==1 %This is for movement with the actuator
                       ...
                       extra_array=linspace(obj.CurrentScanMat{1}(1)-slope*points_extra,obj.CurrentScanMat{1}(1)-slope,points_extra);
                       NewScan=[extra_array obj.CurrentScanMat{1}]; %shift scan region left by extra points
                       r_y=obj.interfaceScanning.Pos(2);
                       r_z=obj.interfaceScanning.Pos(3);
                       pause(50e-3);
                       %[n_points,piezo_sampletime]=obj.interfaceScanning.Trigg_act(NewScan,obj.interfaceScanning.Pos(2),obj.interfaceScanning.Pos(3),handles.ConfocalScan.DwellTime,1,n_points);
                       [n_points,piezo_sampletime]=obj.interfaceScanning.Trigg_act(NewScan,r_y,r_z,handles.ConfocalScan.DwellTime,1,n_points);
                    ...
                    elseif strcmp(scan_code,'xZ')&& Piezotoggle==0
                        ...
                        extra_array=linspace(obj.CurrentScanMat{3}(1)-slope*points_extra,obj.CurrentScanMat{3}(1)-slope,points_extra);
                        NewScan=[extra_array obj.CurrentScanMat{3}]; %shift scan region left by extra points
                        [n_points,piezo_sampletime]=obj.interfaceScanning.Trigg(obj.CurrentScanMat{1}(ind),obj.interfaceScanning.Pos(2),NewScan,handles.ConfocalScan.DwellTime,3,n_points);
                       
                        %[n_points,piezo_sampletime]=obj.interfaceScanning.Trigg(obj.CurrentScanMat{1}(ind),obj.interfaceScanning.Pos(2),obj.CurrentScanMat{3},handles.ConfocalScan.DwellTime,3,n_points);
                        ramp_axis=3;
                        obj.interfaceScanning.WAVETABLE_ENABLE(1,ramp_axis);
                        obj.interfaceDataAcq.StartTask('Counter');
                        obj.interfaceScanning.WAVETABLE_ACTIVE(1,ramp_axis);
                    ...
                    elseif strcmp(scan_code,'Yz')&& Piezotoggle==0
                        ...
                        extra_array=linspace(obj.CurrentScanMat{2}(1)-slope*points_extra,obj.CurrentScanMat{2}(1)-slope,points_extra);
                        NewScan=[extra_array obj.CurrentScanMat{2}]; %shift scan region left by extra points
                        [n_points,piezo_sampletime]=obj.interfaceScanning.Trigg(obj.interfaceScanning.Pos(1),NewScan,obj.CurrentScanMat{3}(ind),handles.ConfocalScan.DwellTime,2,n_points);
                        
                         %[n_points,piezo_sampletime]=obj.interfaceScanning.Trigg(obj.interfaceScanning.Pos(1),obj.CurrentScanMat{2},obj.CurrentScanMat{3}(ind),handles.ConfocalScan.DwellTime,2,n_points);
                         ramp_axis=2;
                         obj.interfaceScanning.WAVETABLE_ENABLE(1,ramp_axis);
                         obj.interfaceDataAcq.StartTask('Counter');
                         obj.interfaceScanning.WAVETABLE_ACTIVE(1,ramp_axis);
                      ...
                      elseif strcmp(scan_code,'Yz')&& Piezotoggle==1 %This is for movement with the actuator
                          absolutePosition = (handles.Zactinit + obj.CurrentScanMat{3}(ind)*1e-3)*1e-3; %thats because we enter the numbers in microns
                          [ret err] = ZaberMoveAbsolute(zaber_obj, zaber_obj.deviceIndex, absolutePosition);
                          set(handles.slider_obj, 'Value', ret(2)*1e3);
                          set(handles.Pos_obj, 'String', num2str(ret(2)*1e3));
                          ...
                          extra_array=linspace(obj.CurrentScanMat{2}(1)-slope*points_extra,obj.CurrentScanMat{2}(1)-slope,points_extra);
                          NewScan=[extra_array obj.CurrentScanMat{2}]; %shift scan region left by extra points
                          r_x=obj.interfaceScanning.Pos(1);
                          r_z=obj.interfaceScanning.Pos(3);
                          pause(50e-3);
                         
                          [n_points,piezo_sampletime]=obj.interfaceScanning.Trigg_act(r_x,NewScan,r_z,handles.ConfocalScan.DwellTime,2,n_points);
                    ...
                    elseif strcmp(scan_code,'yZ') && Piezotoggle==0
                        ...
                        extra_array=linspace(obj.CurrentScanMat{3}(1)-slope*points_extra,obj.CurrentScanMat{3}(1)-slope,points_extra);
                        NewScan=[extra_array obj.CurrentScanMat{3}]; %shift scan region left by extra points
                        [n_points,piezo_sampletime]=obj.interfaceScanning.Trigg(obj.interfaceScanning.Pos(1),obj.CurrentScanMat{2}(ind),NewScan,handles.ConfocalScan.DwellTime,3,n_points);
                        
                        %[n_points,piezo_sampletime]=obj.interfaceScanning.Trigg(obj.interfaceScanning.Pos(1),obj.CurrentScanMat{2}(ind),obj.CurrentScanMat{3},handles.ConfocalScan.DwellTime,3,n_points);
                        ramp_axis=3;
                        obj.interfaceScanning.WAVETABLE_ENABLE(1,ramp_axis);
                        obj.interfaceDataAcq.StartTask('Counter');
                        obj.interfaceScanning.WAVETABLE_ACTIVE(1,ramp_axis);
...
%                 
               ...
               %D=A;
                ...
                title(handles.imageAxes,datestr(now,'yyyy-mm-dd-HHMMSS'));
...
%         end
%         
%         function handles = StartScan2D_back(obj,handles)
%             %tic
%             % set up waitbar
%             
%             for k=1:3
...
%         end
%         
%         function handles = StartScan2D_new_2(obj,handles)
%             %tic
%             % set up waitbar
%             
%             for k=1:3
...
%             drawnow();
            ...
            pcolor(handles.imageAxes,argX,argY,argData);
            shading (handles.imageAxes,'interp');
            colormap(handles.imageAxes,hot2);
            set(handles.imageAxes,'YDir','normal');
            daspect(handles.imageAxes,[1 1 1]);
            set(handles.imageAxes,'ticklength',[0.02 0.02]);
            set(handles.imageAxes,'tickdir','out');
            xlabel(handles.imageAxes,textxlabel);
            ylabel(handles.imageAxes,textylabel);
            axis(handles.imageAxes,[min(argX), max(argX), min(argY), max(argY)]);
            grid(handles.imageAxes);
            set(handles.imageAxes,'layer','top');
            set(handles.imageAxes,'LineWidth',2);
            
            %h = colorbar(handles.imageAxes,'EastOutside');
            h = colorbar('peer',handles.imageAxes);
            set(get(h,'ylabel'),'String','kcps');
            drawnow();
...
%                     set(handles.Note, 'Enable','on');
        ...
        function DisplayImage(obj,handles)
            ...
            title(handles.imageAxes,handles.ConfocalScanDisplayed.DateTime);
        end
            ...
            while (~obj.TrackerhasAborted && (iterCounter < obj.TrackerMaxIterations) && (CurrentStepSize(1) >  obj.TrackerMinimumStepSize(1)) && ...
                ...
                if  sum(bThresh)==0,
                    ...
                    %if norm(G) < 1e-8
                        ...
                        posMove = G/normG.*CurrentStepSize;
                        Pos = Pos + posMove;
                    end
                  %  
                end
        ...
        function [power_data_in_V,power_stdev_in_V,power_array] = MonitorPower(obj)
            ...
            max_signal = 0.05; % in V
            min_signal = -0.05; % in V
        ...
        function handles = refresh_motorX_Callback(obj,handles)
            zaber_motorX = handles.zaber_motorX;
            [ret err] = ZaberReturnCurrentPosition(zaber_motorX, zaber_motorX.deviceIndex);
            set(handles.slider_motorX, 'Value', ret(2)*1e3);
            set(handles.Pos_motorX, 'String', num2str(ret(2)*1e3));
        end
        
        function handles = refresh_motorY_Callback(obj,handles)
            zaber_motorY = handles.zaber_motorY;
            [ret err] = ZaberReturnCurrentPosition(zaber_motorY, zaber_motorY.deviceIndex);
            set(handles.slider_motorY, 'Value', ret(2)*1e3);
            set(handles.Pos_motorY, 'String', num2str(ret(2)*1e3));
        end
        
        function handles =  move_motorY_Callback(obj,handles)
            absolutePosition = str2num(get(handles.Pos_motorY, 'String'))*1e-3;
            zaber_motorY = handles.zaber_motorY;
            [ret err] = ZaberMoveAbsolute(zaber_motorY, zaber_motorY.deviceIndex, absolutePosition);
            set(handles.slider_motorY, 'Value', ret(2)*1e3);
            set(handles.Pos_motorY, 'String', num2str(ret(2)*1e3));
            refresh_motorY_Callback(obj,handles);
        end
             
        function handles =  move_motorX_Callback(obj,handles)
            absolutePosition = str2num(get(handles.Pos_motorX, 'String'))*1e-3;
            zaber_motorX = handles.zaber_motorX;
            [ret err] = ZaberMoveAbsolute(zaber_motorX, zaber_motorX.deviceIndex, absolutePosition);
            set(handles.slider_motorX, 'Value', ret(2)*1e3);
            set(handles.Pos_motorX, 'String', num2str(ret(2)*1e3));
            refresh_motorX_Callback(obj,handles);
        end
...
%              
        ...
        function UpdateScanList(handles)
            ...
            fp = 'C:\QEG2\21-C\SavedImages';%getpref('nv','SavedImageDirectory');
            files = dir(fp);
